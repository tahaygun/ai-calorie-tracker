      ...
      <div className='space-y-5 bg-gray-800 shadow-lg p-6 rounded-lg'>
        ...
        <div>
          ...
          <input
            ...
            className='border-gray-600 bg-gray-700 p-2 border rounded w-full text-gray-100'
            placeholder='sk-...'
          />
        ...
        <div className='flex items-center gap-2'>
          <input
            ...
            className='border-gray-600 bg-gray-700 rounded focus:ring-blue-500 text-blue-500'
          />
